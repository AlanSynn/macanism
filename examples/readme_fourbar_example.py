...
# Create the macanism object
macanism = macanism(vectors=(a, b, c, d), origin=O, loops=loop, pos=theta, vel=omega, acc=alpha,
                      guess=(pos_guess, vel_guess, acc_guess))

# Call macanism.iterate() then get and show the animation
macanism.iterate()
ani, fig_, ax_ = macanism.get_animation()
