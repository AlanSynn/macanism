...
# macanism = macanism(vectors=(a, b, c, d, e, f, x, y), input_vector=a, loops=loops, pos=0, guess=(guess,))
# macanism.calculate()
# macanism.plot()

t2 = np.linspace(0, 6*np.pi, 300)
macanism = macanism(vectors=(a, b, c, d, e, f, x, y), origin=O2, loops=loops, pos=t2, guess=(guess, ))
macanism.iterate()
